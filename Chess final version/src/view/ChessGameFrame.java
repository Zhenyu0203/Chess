...
//    }
    ...
    public void initCurrentPlayerLabel() {
        ...
        currentPlayerCube.setBackground(Color.white);
    ...
    public void setBlackPlayerLabel() {
        ...
        currentPlayerCube.setOpaque(true);
        currentPlayerCube.setBackground(Color.black);
        add(currentPlayerCube);
        this.repaint();
    }
    ...
    public void addPreviousMoveButton() {
        JButton button = new JButton("Check last move");
        Chessboard chessboard=gameController.getChessboard();
        button.addActionListener((e) -> {
            chessboard.checkPreviousBoard();
            t.suspend();
        });
    ...
    public void addNextMoveButton() {
        JButton button = new JButton("Check next move");
        Chessboard chessboard=gameController.getChessboard();
        button.addActionListener((e) ->
        {
            chessboard.checkNextBoard();
            t.suspend();
        });
    ...
    public void addReturnButton() {
        ...
        Chessboard chessboard=gameController.getChessboard();
        button.addActionListener((e) -> {
            chessboard.returnToCurrentBoard();
            if (timelimit!=0){
                t.resume();
            }
        });
    ...
    public void addChangeThemeButton() {
        ...
        Chessboard chessboard=gameController.getChessboard();
        button.addActionListener(e -> {
                    chessboard.changeTheme(changeThemeTime);
                    if (changeThemeTime==0){
                        changeThemeTime++;
                    }else {
                        changeThemeTime--;
                    }
